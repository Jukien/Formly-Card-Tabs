...
@Component({
  selector: 'app-formly-using-card',
  templateUrl: './formly-using-card.component.html',
  styleUrls: ['./formly-using-card.component.scss']
})
export class FormlyUsingCardComponent implements OnDestroy {
